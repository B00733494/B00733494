...
log_path = 'dvwa_bad.log'
output_csv_log = 'dvwa_bad_low.csv'
class_flag = "bad"
class LogParse:
    def __init__(self):
        pass
...
def ExtractFeatures(method,path_enc,body_enc,headers):
    ...
    return [method,path_enc.encode('utf-8').strip(),body_enc.encode('utf-8').strip(),single_q,double_q,dashes,braces,spaces,badwords,class_flag]
    raw_input('>>>')
